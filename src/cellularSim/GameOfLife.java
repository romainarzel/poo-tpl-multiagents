...
/**
 * Classe principale pour lancer une simulation du jeu de la vie de Conway.
 * 
 * <p>
 * Cette classe contient la méthode {@code main} qui initialise et démarre une
 * simulation graphique interactive du célèbre automate cellulaire de John
 * Horton Conway.
 * </p>
 * 
 * <p>
 * Le programme propose plusieurs configurations initiales :
 * <ul>
 * <li>Un planeur (glider) - motif mobile classique</li>
 * <li>Un carré de cellules - évolue vers 4 colonies stables</li>
 * <li>Une grille aléatoire - génération procédurale (configuration par
 * défaut)</li>
 * </ul>
 * </p>
 * 
...
public class GameOfLife {
    /**
     * Lance la simulation du jeu de la vie de Conway.
     * 
     * <p>
     * Initialise une grille 50x50 avec une configuration aléatoire de cellules
     * vivantes,
    ...
    public static void main(String[] args) {
        ...
        for (int col = 0; col < width; col++) {
            for (int lig = 0; lig < height; lig++) {
                if (rng.nextBoolean() /* && rng.nextBoolean() */) { // You can uncomment the second test to make alive
                                                                    // cells less likely
